...
function enableButton(letter, capital, number, length, match) {
    ...
    var c1 = document.getElementById('letter').classList.contains('valid')
    var c2 = document.getElementById('capital').classList.contains('valid')
    var c3 = document.getElementById('number').classList.contains('valid')
    var c4 = document.getElementById('length').classList.contains('valid')
    var c5 = document.getElementById('match').classList.contains('valid')
    var button = document.getElementById('my_submit_button');
    var condition = (c1 && c2 && c3 && c4 && c5); // TODO: Replace false with the correct condition
    if(condition) {       
