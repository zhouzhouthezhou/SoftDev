...
app.get('/player_info/post', function(req, res) {
	...
	var query3 = "select count(football_games.*) from football_players inner join football_games on football_players.id = any(football_games.players) where football_players.name=\'" + req.query.player_choice + "\'"
	db.task('get-everything', task => {
		return task.batch([
			task.any(query1),
			task.any(query2),
